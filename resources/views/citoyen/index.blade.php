            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button
                            class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 transition duration-200">
                    ...
                    <p class="text-sm text-gray-600 mt-4">Pour ajouter un membre de votre famille, cliquez sur
                        "Nouveau".</p>
                </div>
            </div>
