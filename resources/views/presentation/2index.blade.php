@extends('layouts.ladding')
@section('content')
<main class="flex-shrink-0">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
        <div class="container px-5">
            <a class="navbar-brand" href="{{ route('presentation.index') }}"><span class="fw-bolder text-primary">
                    IDocsMali</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                    <li class="nav-item"><a class="nav-link" href="{{ route('presentation.index') }}">Accueil</a></li>
                    <li class="nav-item"><a class="nav-link" href="resume.html">A propos</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('login') }}">Ce connecter</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="row gx-12 align-items-center">
            <div class="col-xxl-5">
                <!-- Header text content-->
                <div class="text-center text-xxl-start bg-image">
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Faite vos demandes
                            administrative avec aisance</span></h1>
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                        <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                            href="{{ route('login') }}">Faire
                            une demande</a>
                        <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="projects.html">Nous
                            contacter</a>
                    </div>
                </div>
            </div>
            <div class="container px-12 pb-12">
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img" src="{{ asset('presentation/assets/profile.png') }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Idocs Mali</span></h2>
                        <p class="lead fw-light mb-4">Est une solution digital facilitan les opereation administrative
                        </p>
