...
<section
    ...
    <div class="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 animate-scale-in">
            <a href="{{ route('presentation.demander_acte') }}"
                class="inline-block bg-white text-blue-600 hover:bg-blue-100 px-8 py-4 rounded-lg text-lg font-semibold shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
                Demander un Acte
            </a>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4 text-center max-w-5xl">
        ...
        <a href="{{ route('presentation.la_demarche') }}"
            class="inline-block text-blue-400 hover:text-blue-800 font-semibold mt-10 text-lg">
    ...
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-center mb-12">
            ...
            <img src="https://via.placeholder.com/150x80?text=Partenaire+1" alt="Partenaire 1"
                class="mx-auto max-h-20 opacity-75 hover:opacity-100 transition duration-300">
        ...
        <p class="text-gray-700 text-lg max-w-2xl mx-auto">
            MaliActes s'engage à garantir la confidentialité et la sécurité de toutes vos informations. Votre confiance
            est notre priorité.
        </p>
    </div>
</section>
...
<section class="bg-blue-400 text-white py-20 text-center">
    <div class="container mx-auto px-4">
        ...
        <a href="{{ route('presentation.demander_acte') }}"
            class="inline-block bg-white text-blue-700 hover:bg-blue-100 px-10 py-5 rounded-lg text-xl font-semibold shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
