...
@section('title', 'Notre Vision - MaliActes')
    ...
    <div class="mb-8">
       <img src="{{ asset('./images/notre_vision2.png') }}" 
        ...
        <ul class="list-disc list-inside text-lg text-gray-700 dark:text-gray-300 space-y-3">
            <li><span class="font-semibold text-blue-600 dark:text-blue-400">Accessibilité Universelle :</span> Permettre à chaque Malien, y compris ceux de la diaspora, d'accéder à leurs documents d'état civil.</li>
            ...
            <li><span class="font-semibold text-blue-600 dark:text-blue-400">Fiabilité des Registres :</span> Contribuer à la numérisation et à la sécurisation des archives nationales d'état civil.</li>
        ...
        <div class="text-center mt-12">
            <p class="text-xl font-semibold text-gray-800 dark:text-gray-200">Ensemble, construisons l'avenir numérique des services publics au Mali.</p>
        </div>
    </div>
</section>
