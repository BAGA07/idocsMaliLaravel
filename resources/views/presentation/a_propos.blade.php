...
<section class="py-16 bg-white dark:bg-gray-800">
    <div class="container mx-auto px-4 max-w-5xl text-center">
        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-8">
            MaliActes : Notre Engagement pour un Mali Numérique
        </h1>
        <p class="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-12">
            MaliActes est une initiative audacieuse visant à moderniser l'accès aux documents d'état civil au Mali. Nous croyons en un avenir où chaque citoyen peut accéder facilement et en toute sécurité à ses droits fondamentaux, où qu'il se trouve. Découvrez notre vision, nos valeurs et l'équipe derrière ce projet transformateur.
        </p>
