            ...
            <table class="min-w-full table-auto border text-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border">@if(!$acte->finalized) <span
                                class="bg-yellow-200 text-yellow-800 px-2 py-1 rounded">À finaliser</span> @else <span
                                class="bg-green-200 text-green-800 px-2 py-1 rounded">Finalisé</span> @endif</td>
                        <td class="px-4 py-2 border">
                            @if(!$acte->finalized)
                            <a href="{{ route('officier.actes.finaliser', $acte->id) }}"
                                class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Finaliser</a>
                            @else
                            {{-- <a href="{{ route('officier.actes.pdf', $acte->id) }}"
                                class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">PDF</a> --}}
                            @endif
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">Aucun acte à finaliser.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="min-w-full table-auto border text-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border">
                            <a href="{{ route('officier.copies.finaliser', $copie->id) }}"
                                class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Finaliser</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">Aucune copie/extrait à finaliser.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border">
                            {{-- <a href="{{ route('officier.actes.pdf', $acte->id) }}"
                                class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">PDF</a> --}}
                            <a href="{{ route('officier.acte.show', $acte->id) }}"
                                class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 text-sm">Voir</a>
                        </td>
            ...
            <table class="min-w-full table-auto border text-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border">
                            <a href="{{ route('officier.copies.show', $copie->id) }}"
                                class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 text-sm">Voir</a>
                            {{-- <a href="{{ route('officier.copies.pdf', $copie->id) }}"
                                class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">PDF</a> --}}
                        </td>
                    </tr>
                    @endforeach
