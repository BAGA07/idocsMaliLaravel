        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Ajoutez un nouvel agent hôpital ou mairie</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('manager.agents.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Informations de connexion</h3>
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2 mt-6">Affectation à une structure</h3>
                        
                        <div>
                            <label for="structure" class="block text-sm font-medium text-gray-700 mb-1">Type de structure *</label>
                            <select name="structure" id="structure" required onchange="updateStructureOptions()"
                                ...
                                <option value="hopital" {{ old('structure') == 'hopital' ? 'selected' : '' }}>Hôpital</option>
                                <option value="mairie" {{ old('structure') == 'mairie' ? 'selected' : '' }}>Mairie</option>
                            </select>
                            @error('structure')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            <label for="structure_id" class="block text-sm font-medium text-gray-700 mb-1">Structure *</label>
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fa fa-save mr-2"></i> Créer l'agent
                    </button>
                </div>
            </form>
        </div>
...
function updateStructureOptions() {
    ...
    if (structureType === 'hopital') {
        hopitaux.forEach(hopital => {
            ...
            option.textContent = hopital.nom_hopital;
            structureSelect.appendChild(option);
        });
    } else if (structureType === 'mairie') {
