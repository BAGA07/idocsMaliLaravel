    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
        <ul
          ...
          <li>
            <a href="{{ route('presentation.a_propos') }}" id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
          ...
          <li class="md:ml-4">
            <a href="{{ route('demande.create') }}"
              class="text-white bg-blue-400 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
              Demander un Acte
            </a>
          </li>
        </ul>
