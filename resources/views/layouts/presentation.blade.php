  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
          <a href="{{ route('presentation.a_propos_main') }}" id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
            Le Projet / À Propos
        ...
        <li class="md:ml-4">
          <a href="{{ route('demande.choix_type') }}" class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Demander un Acte
          </a>
        </li>
      </ul>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div class="col-span-1">
                ...
                <div class="flex space-x-4">
                    {{-- Facebook Icon --}}
                    <a href="URL_DE_VOTRE_PAGE_FACEBOOK" class="text-blue-200 hover:text-white transition duration-200" aria-label="Facebook">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.776-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33V22C17.34 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                    </a>

                    {{-- LinkedIn Icon --}}
                    <a href="URL_DE_VOTRE_PROFIL_LINKEDIN" class="text-blue-200 hover:text-white transition duration-200" aria-label="LinkedIn">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M0 .00099987C0 .00099987 0 24 0 24L5 24L5 7.96200003L0 7.96200003L0 .00099987ZM2.5 6.13600003C3.882 6.13600003 4.999 5.02100003 4.999 3.63600003C4.999 2.25100003 3.882 1.13600003 2.5 1.13600003C1.119 1.13600003 0 2.25100003 0 3.63600003C0 5.02100003 1.119 6.13600003 2.5 6.13600003ZM6.5 7.96200003L6.5 24L11.5 24L11.5 16.035C11.5 14.281 12.898 12.883 14.652 12.883C16.406 12.883 17.5 14.18 17.5 16.035L17.5 24L22.5 24L22.5 15.698C22.5 11.233 19.467 9.13600003 16.924 9.13600003C14.779 9.13600003 13.565 10.379 12.843 11.411L12.843 11.411L12.843 7.96200003L6.5 7.96200003Z" clip-rule="evenodd" />
                        </svg>
                    </a>

                    {{-- GitHub Icon --}}
                    <a href="URL_DE_VOTRE_PROFIL_GITHUB" class="text-blue-200 hover:text-white transition duration-200" aria-label="GitHub">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
