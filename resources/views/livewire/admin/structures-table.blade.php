<div class="w-full">
        ...
        <div class="bg-white rounded-lg shadow-md">
            <div class="border-b border-gray-200">
                <nav class="flex space-x-8 px-6" aria-label="Tabs">
                    <button class="py-4 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'hopitaux' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}" 
                            wire:click="$set('activeTab', 'hopitaux')" type="button">
                        <i class="fas fa-hospital mr-2"></i> Hôpitaux
                    </button>
                    <button class="py-4 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'mairies' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}" 
    ...
    <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full {{ $showCreateModal || $showEditModal ? '' : 'hidden' }}" id="modal">
            ...
            <div class="mt-3">
                ...
                <form wire:submit.prevent="{{ $showCreateModal ? 'createStructure' : 'updateStructure' }}">
                    ...
                    <div class="flex justify-end space-x-3 mt-6">
                        <button type="button" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg transition duration-200" wire:click="closeModals">
                            Annuler
                        </button>
    ...
    <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full {{ $showDeleteModal ? '' : 'hidden' }}" id="deleteModal">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-gray-600 mb-6">Êtes-vous sûr de vouloir supprimer cette structure ? Cette action est irréversible.</p>
                
                <div class="flex justify-end space-x-3">
                    <button type="button" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg transition duration-200" wire:click="closeModals">
                        Annuler
                    </button>
                    <button type="button" class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200" wire:click="deleteStructure">
                        Supprimer
                    </button>
                </div>
            </div>
