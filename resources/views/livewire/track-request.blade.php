<div class="bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-md">
    <div class="mb-6">
        <label for="trackingNumber" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Votre numéro
            de suivi:</label>
        <input wire:model.live="trackingNumber" type="text" id="trackingNumber"
            class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 dark:bg-gray-600 dark:text-white leading-tight focus:outline-none focus:shadow-outline focus:ring-blue-500 focus:border-blue-500"
            placeholder="Ex: MALIACTES123">
    ...
    <div class="flex items-center justify-center mb-6">
        <button wire:click="track" wire:loading.attr="disabled"
            class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 ease-in-out transform hover:scale-105 {{ $isLoading ? 'opacity-75 cursor-not-allowed' : '' }}">
    ...
    <div class="mt-6 p-4 rounded-lg
                ...
                @elseif ($status === 'Prêt pour retrait' || $status === 'Terminée') bg-green-100 text-green-800 border border-green-300
