...
<div
    class="acte-imprimable max-w-3xl mx-auto bg-white border border-black font-serif text-sm print:p-4 print:w-full print:max-w-full print:border-none print:shadow-none relative">
    ...
    <div class="border border-black p-4">
            ...
            {{-- Cachet et Signature --}}
            <div class="border border-black mx-2 flex items-center mb-2 relative z-10" {{-- style="background-color: hsla(0, 93%, 6%, 0.10); --}}">
