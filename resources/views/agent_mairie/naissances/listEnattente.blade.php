...
<div class="max-w-6xl mx-auto mt-10 p-6 bg-white rounded shadow-lg">
    ...
    <p class="mb-6 text-gray-700">
        Ces demandes concernent la délivrance de copies d'actes de naissance déjà enregistrés, ou de nouvelles demandes
        de copies d'extraits.
    </p>
    ...
    <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded mb-12" role="alert">
        ...
        <p>Aucune deman de de copie d'extrait d'acte n'est en attente de traitement pour le moment.</p>
    </div>
    @else
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100">
                    ...
                    <td class="px-4 py-3 border border-gray-300 whitespace-nowrap">
                        ...
                        @case('Validé')
                        <span
                            class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Validé</span>
                        @break
                        @case('Rejeté')
                        <span
                            class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Rejeté</span>
                        @break
                        @default
                        <span
                            class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">{{
                            $demandeCopie->statut }}</span>
                        @endswitch
                    </td>
    ...
    <p class="mb-6 text-gray-700">
        Ces demandes proviennent des déclarations de naissance faites par les hôpitaux. Elles sont prêtes à être
        converties en actes de naissance officiels après vérification.
    </p>
