...
<div class="acte-imprimable max-w-3xl mx-auto bg-white border border-black p-6 font-serif text-sm print:p-4 print:w-full print:max-w-full print:border-none print:shadow-none relative">
...
<div class="border border-black mx-2 mb-2 flex">
    ...
    <div class="flex-1 p-2 space-y-1">
        ...
        <p class="flex items-end mb-1"><strong>6. Localité ou pays de naissance :</strong> <span class="uppercase border-b border-black flex-grow text-left px-1">{{ $copie->lieu_naissance_enfant }}</span></p>
