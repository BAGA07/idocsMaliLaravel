    ...
    <form action="{{ route('hopital.demandes.envoyer', $declaration->id_volet) }}" method="POST">
      ...
      <div class="modal-custom-body">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nom_complet" name="nom_complet" value="{{ $declaration->declarant->nom_declarant }} {{ $declaration->declarant->prenom_declarant }}" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="telephone" name="telephone" value="{{ $declaration->declarant->telephone }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="message_hopital" name="message_hopital" rows="2">Demande d'acte de naissance initiée par l'hôpital pour le volet N° {{ $declaration->num_volet }}</textarea>
        </div>
        <div class="mb-3">
          <label class="form-label">Mairie destinataire</label>
          <input type="text" class="form-control" value="{{ isset($mairieCommune) ? $mairieCommune->nom_mairie : 'Aucune mairie trouvée' }}" disabled>
...
.modal-custom-body input, .modal-custom-body textarea {
  margin-bottom: 10px;
  border-radius: 6px;
...
.modal-custom-body input:focus, .modal-custom-body textarea:focus {
  border: 1.5px solid #2563eb;
  outline: none;
}
@media (max-width: 600px) {
  .modal-custom-content { max-width: 98vw; }
  .modal-custom-header, .modal-custom-footer { padding: 14px 10px; }
}
</style>
