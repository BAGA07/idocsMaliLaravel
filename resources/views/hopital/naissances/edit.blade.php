    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-cover bg-center"
        ...
        <form method="POST" action="{{ route('naissances.update', $volet->id_volet) }}"
            ...
            <div class="text-center">
                ...
                <p class="mt-6 text-xl font-semibold text-gray-800 dark:text-gray-200">Modifier Déclaration de Naissance</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="date_naissance" id="date_naissance" value="{{ old('date_naissance', $volet->date_naissance) }}"
                    ...
                    <div>
                        ...
                        <input type="time" name="heure_naissance" id="heure_naissance" value="{{ old('heure_naissance', $volet->heure_naissance) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="prenom_enfant" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Prénoms</label>
                        <input type="text" name="prenom_enfant" id="prenom_enfant" value="{{ old('prenom_enfant', $volet->prenom_enfant) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nom_enfant" id="nom_enfant" value="{{ old('nom_enfant', $volet->nom_enfant) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="prenom_pere" id="prenom_pere" value="{{ old('prenom_pere', $volet->prenom_pere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="age_pere" id="age_pere" value="{{ old('age_pere', $volet->age_pere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="domicile_pere" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Domicile</label>
                        <input type="text" name="domicile_pere" id="domicile_pere" value="{{ old('domicile_pere', $volet->domicile_pere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="ethnie_pere" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ethnie</label>
                        <input type="text" name="ethnie_pere" id="ethnie_pere" value="{{ old('ethnie_pere', $volet->ethnie_pere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        ...
                        <select name="situation_matrimonial_pere" id="situation_matrimonial_pere"
                            ...
                            <option value="Marié" {{ old('situation_matrimonial_pere', $volet->situation_matrimonial_pere) == 'Marié' ? 'selected' : '' }}>Marié</option>
                            <option value="Célibataire" {{ old('situation_matrimonial_pere', $volet->situation_matrimonial_pere) == 'Célibataire' ? 'selected' : '' }}>Célibataire</option>
                            <option value="Divorcé" {{ old('situation_matrimonial_pere', $volet->situation_matrimonial_pere) == 'Divorcé' ? 'selected' : '' }}>Divorcé</option>
                        </select>
                    </div>
                    <div>
                        <label for="niveau_instruction_pere" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Niveau scolaire</label>
                    ...
                    <div>
                        ...
                        <input type="text" name="profession_pere" id="profession_pere" value="{{ old('profession_pere', $volet->profession_pere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="prenom_mere" id="prenom_mere" value="{{ old('prenom_mere', $volet->prenom_mere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="age_mere" id="age_mere" value="{{ old('age_mere', $volet->age_mere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="domicile_mere" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Domicile</label>
                        <input type="text" name="domicile_mere" id="domicile_mere" value="{{ old('domicile_mere', $volet->domicile_mere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        <label for="ethnie_mere" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ethnie</label>
                        <input type="text" name="ethnie_mere" id="ethnie_mere" value="{{ old('ethnie_mere', $volet->ethnie_mere) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
                        ...
                        <select name="situation_matrimonial_mere" id="situation_matrimonial_mere"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            <option value="">-- Choisir --</option>
                            <option value="Marié" {{ old('situation_matrimonial_mere', $volet->situation_matrimonial_mere) == 'Marié' ? 'selected' : '' }}>Marié</option>
                            <option value="Célibataire" {{ old('situation_matrimonial_mere', $volet->situation_matrimonial_mere) == 'Célibataire' ? 'selected' : '' }}>Célibataire</option>
                            <option value="Divorcé" {{ old('situation_matrimonial_mere', $volet->situation_matrimonial_mere) == 'Divorcé' ? 'selected' : '' }}>Divorcé</option>
                        </select>
                    </div>
                    <div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="telephone" id="telephone" value="{{ old('telephone', $volet->declarant->telephone) }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    <div>
