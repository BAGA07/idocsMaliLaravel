...
class VoletDeclarationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Sécurité : Vérifier que les hôpitaux et déclarants existent
        if (empty($hopitalIds) || empty($declarantIds)) {
            $this->command->warn('ATTENTION : Aucun hôpital ou déclarant trouvé. Insérez-les avant d\'exécuter ce seeder.');
            return;
        }
